                ...
                <div className="flex flex-col justify-center">
                    <div className="xl:w-[1140px] mx-auto relative z-30 pb-16 max-xl:px-[40px]">
                                    ...
                                    <div className="relative top-0 z-20 flex flex-col items-center ">
                                        <div className="bg-[#f1c50e] w-[150px] h-[150px] rounded-full flex items-center justify-center">
                                            <Image
                                                ...
                                                src="/images/home/sectionH/535239-76a99baf.png"
                                            />
                                        </div>
                                        <div>
                                            <h3 className="text-[20px] font-Montserrat text-[#1b7bea] font-bold mt-[20px] text-center">
                                                OUR MAIN OFFICE
                                            </h3>
                                    ...
                                    <div className="relative top-0 z-20 flex flex-col items-center ">
                                        <div className="bg-[#f1c50e] w-[150px] h-[150px] rounded-full flex items-center justify-center">
                                            <Image
                                                ...
                                                className="w-[74px] h-[74px]"
                                                style={{ color: "transparent" }}
                                                src="/images/home/sectionH/159832-139ed446.png"
                                            />
                                        </div>
                                        <div>
                                            <h3 className="text-[20px] font-Montserrat text-[#1b7bea] font-bold mt-[20px] text-center">
                                    ...
                                    <div className="relative top-0 z-20 flex flex-col items-center ">
                                        <div className="bg-[#f1c50e] w-[150px] h-[150px] rounded-full flex items-center justify-center">
                                            <Image
                                                ...
                                                className="w-[74px] h-[74px]"
                                                style={{ color: "transparent" }}
                                                src="/images/home/sectionH/561127-c47308a4.png"
                                            />
                                        </div>
                                        <div>
                                            <h3 className="text-[20px] font-Montserrat text-[#1b7bea] font-bold mt-[20px] text-center">
                        ...
                        <div className="mt-[50px]">
                            ...
                            <p className="italic text-white text-[12px]">*Pemberitahuan Resiko</p>
                            <p className="text-white text-[16px] mt-3">
                                ...
                                yang mampu anda tanggung apabila terjadi kerugian. Harap diketahui
                                bahwa produk dengan leverage belum tentu cocok untuk semua orang,
                                jadi pastikan anda telah memahami sepenuhnya semua risiko yang
                                terlibat.
                            </p>
                        </div>
                        <div className="mt-[30px]">
                            ...
                            <div className="mt-[15px] flex justify-between h-max max-sm:flex-col">
                                ...
                                <div className="max-sm:mt-[25px] flex justify-center">
                                    <a target="_blank" href="https://linktr.ee/vplus">
                                        <Image
                                            alt=""
                                            loading="lazy"
                                            width={581}
                                            ...
                                            className="w-[150px]"
                                            style={{ color: "transparent" }}
                                            src="/images/home/sectionH/qrLinktree.png"
                                        />
                                    </a>
                                </div>
                            </div>
