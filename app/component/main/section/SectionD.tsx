                            ...
                            >
                                <switch>
                                    <g>
                                        ...
                                        <path d="m256 331.051c-33.084 0-60 26.908-60 59.983s26.916 59.983 60 59.983 60-26.908 60-59.983-26.916-59.983-60-59.983zm0 89.975c-16.542 0-30-13.454-30-29.992 0-16.537 13.458-29.991 30-29.991s30 13.454 30 29.991c0 16.538-13.458 29.992-30 29.992z" />
                                        <path d="m151 376.039h-30c-8.284 0-15 6.714-15 14.996s6.716 14.996 15 14.996h30c8.284 0 15-6.714 15-14.996s-6.716-14.996-15-14.996z" />
                                        <path d="m391 376.039h-30c-8.284 0-15 6.714-15 14.996s6.716 14.996 15 14.996h30c8.284 0 15-6.714 15-14.996s-6.716-14.996-15-14.996z" />
                                    </g>
                                </switch>
                            </svg>
                        </div>
                    </div>
                    <div className="relative w-[369px] brightness-100 rounded-3xl h-[369px] flex flex-col justify-center items-center overflow-hidden">
                        <Image
                            alt=""
                            loading="lazy"
                            width={1200}
                            ...
                            decoding="async"
                            data-nimg={1}
                            className="absolute z-10 object-cover w-full h-full brightness-[.4]"
                            ...
                            >
                                <switch>
                                    <g>
                                        ...
                                        <path d="M150.072,329.154c-5.855-5.856-15.351-5.856-21.207,0l-21.207,21.207c-5.856,5.856-5.856,15.351,0,21.207    c5.855,5.856,15.352,5.856,21.207,0l21.207-21.207C155.928,344.505,155.928,335.01,150.072,329.154z" />
                                        <path d="M346.19,0c-8.282,0-14.996,6.714-14.996,14.996v29.992c0,8.282,6.714,14.996,14.996,14.996s14.996-6.714,14.996-14.996    V14.996C361.186,6.714,354.472,0,346.19,0z" />
                                        ...
                                        <path d="M446.769,34.383c-5.855-5.856-15.351-5.856-21.207,0L395.57,64.375c-5.856,5.856-5.856,15.351,0,21.207    c5.855,5.856,15.351,5.857,21.207,0l29.992-29.992C452.625,49.734,452.625,40.24,446.769,34.383z" />
                                    </g>
                                </switch>
                            </svg>
                        </div>
                    </div>
                    <div className="relative w-[369px] bg-center bg-cover brightness-100 rounded-3xl h-[369px] p-[30px] flex flex-col justify-center items-center overflow-hidden">
                        <Image
                            alt=""
                            loading="lazy"
                            width={800}
