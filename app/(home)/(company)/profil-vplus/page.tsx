            ...
            <section className="flex justify-center">
                <div className="w-[1140px] flex max-sm:flex-col justify-center items-center h-full gap-[40px] py-[25px]">
                    <div className="relative w-[250px] h-[100px]">
                        <div className="bg-[#37e773] w-[250px] h-[100px] relative z-10">
                            <div className="absolute z-20 flex flex-col text-white justify-center left-5">
                    ...
                    <div className="w-full px-5 shrink max-sm:mt-2">
                        <p className="font-bold font-Open_Sans text-white text-[20px]">Vplus.id</p>
                ...
                <div className="w-[1140px] flex flex-col justify-center items-center h-full py-[40px] max-lg:px-5 max-sm:gap-8">
                    <div className="flex gap-10 max-sm:flex-col">
                        <div className="flex flex-col items-center justify-center w-full font-Open_Sans shrink">
                            <h1 className="text-[40px] text-white font-bold uppercase">our vision</h1>
                            <p className="text-[11px] font-bold text-white uppercase mb-[25px]">
                                (solusi trading yang lebih efisien)
                            </p>
                            <p className="text-left text-white max-sm:text-center">
                        ...
                        <div className="relative max-sm:w-[270px] max-sm:h-[220px] sm:w-[300px] sm:h-[250px]">
                            <div className="bg-[#37e773] max-sm:w-[220px] max-sm:h-[220px] sm:w-[250px] sm:h-[250px] rounded-full absolute z-10 right-0 top-0" />
                            <Image
                                alt=""
                                loading="lazy"
                                width={983}
                    ...
                    <div className="flex gap-10 max-sm:flex-col">
                        ...
                        <div className="flex flex-col items-center justify-center w-full font-Open_Sans shrink">
                            <h1 className="text-[40px] text-white font-bold uppercase">our mission</h1>
                            <p className="text-[11px] text-white font-bold uppercase mb-[25px]">
                                (edukasi trader)
                            </p>
                            <p className="text-right text-white max-sm:text-center">
